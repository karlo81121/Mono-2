...
namespace Employeess.Service
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task<List<Employee>> GetAllEmployeesAsync([FromUri] Paging paging, [FromUri] Sorting sorting, [FromUri] EmployeeFiltering filtering)
        {
            List<Employee> employees = await employeeRepository.GetAllEmployeesAsync(paging, sorting, filtering);
            return employees;
        }
