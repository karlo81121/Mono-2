...
namespace Employeess.Service
{
    public class SalaryService : ISalaryService
    {
        ...
        public async Task<List<Salary>> GetAllSalariesAsync([FromUri] Paging paging, [FromUri] Sorting sorting, [FromUri] SalaryFiltering filtering)
        {
            List<Salary> salaries = await salaryRepository.GetAllSalariesAsync(paging, sorting, filtering);
            return salaries;
        }
